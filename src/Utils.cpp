        ...
        for (auto x = 0; x < newWidth; x += 2 * (scale < 2 ? cfaSize : 1)) {
            ...
            if (cfaSize < 2 | scale > 1) {
                ...
                if(applyShadingMap) {                              
                    ...
                    shadingMapVals[1] = getShadingMapValue((srcX + left) * shadingMapScaleX, (srcY + top) * shadingMapScaleY, 1, lensShadingMap, metadata.lensShadingMapWidth, metadata.lensShadingMapHeight);
                    shadingMapVals[2] = getShadingMapValue((srcX + left) * shadingMapScaleX, (srcY + top) * shadingMapScaleY, 2, lensShadingMap, metadata.lensShadingMapWidth, metadata.lensShadingMapHeight);
                    shadingMapVals[3] = getShadingMapValue((srcX + left) * shadingMapScaleX, (srcY + top) * shadingMapScaleY, 3, lensShadingMap, metadata.lensShadingMapWidth, metadata.lensShadingMapHeight);
                }
