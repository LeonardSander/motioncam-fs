...
MountId FuseFileSystemImpl_MacOs::mount(FileRenderOptions options, int draftScale, const std::string cfrTarget, const std::string cropTarget, const std::string& srcFile, const std::string& dstPath, const std::string& cameraModel) {
...
void FuseFileSystemImpl_MacOs::updateOptions(MountId mountId, FileRenderOptions options, int draftScale, std::string cfrTarget, std::string cropTarget, const std::string& cameraModel) {
    auto it = mMountedFiles.find(mountId);
    if(it != mMountedFiles.end()) {
        it->second->updateOptions(options, draftScale, cfrTarget, cropTarget, cameraModel);
    }
}
